...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, tableView.width, 51)];
    ...
    if (indexPath.row == self.hlightButton || [self.titleArray[indexPath.row] isEqualToString:self.hlightString]) {
        if (self.colorStr == nil) {
            cell.textLabel.textColor = HEXRGBCOLOR(0x666666);
        }else {
...
- (void)tableView:(UITableView *)tableView didHighlightRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.textColor = HEXRGBCOLOR(0xffffff);
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.delegate respondsToSelector:@selector(globeBottomViewButtonClick:logo:)]) {
        [self.delegate globeBottomViewButtonClick:indexPath.row logo:_title];
    }
