...
- (void)layoutSubviews {
    ...
    if (self.topSignImageView.image == nil) {
        ...
        //原：topLabelX = CGRectGetMaxX(self.topSignImageView.frame) + 0.5 * spacing;
        topLabelX = CGRectGetMaxX(self.topSignImageView.frame) + Size(9);
    }
    ...
    if (self.bottomSignImageView.image == nil) {
        ...
        //原：bottomLabelX = CGRectGetMaxX(self.bottomSignImageView.frame) + 0.5 * spacing;
        bottomLabelX = CGRectGetMaxX(self.bottomSignImageView.frame) + Size(9);
    }
